...
//  codepathprework
//
//  Created by Erica Amponsah on 12/29/22.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func introduceSelfDidTapped(_ sender: UIButton) {
        ...
        let introduction = "My name is \(firstNameTextField.text!) \(lastNameTextField.text!) and I attend \(schoolNameTextField.text!). I am currently in my \(year!) year and I own \(numberOfPetsLabel.text!) dogs. My clubs are \(hobbiesTextField.text!). I am in \(numberOfClubsLabel.text!) clubs. It is \(morePetsSwitch.isOn) that I want more pets."
